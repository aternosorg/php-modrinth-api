...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.modrinth.com/v2';
    ...
    {
        $report  = 'PHP SDK (Aternos\ModrinthApi) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: v2.7.0/366f528' . PHP_EOL;
