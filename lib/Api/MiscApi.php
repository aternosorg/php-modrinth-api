...
class MiscApi
{
     ...
     * @param  string|null $neoforge Whether to include NeoForge versions. Can be &#x60;only&#x60; (NeoForge-only versions), &#x60;include&#x60; (both Forge and NeoForge versions), or omitted (Forge-only versions). (optional)
     ...
     */
    public function forgeUpdates($id_slug, $neoforge = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['forgeUpdates'][0])
    {
        list($response) = $this->forgeUpdatesWithHttpInfo($id_slug, $neoforge, $hostIndex, $variables, $contentType);
        return $response;
    }
     ...
     */
    public function forgeUpdatesWithHttpInfo($id_slug, $neoforge = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['forgeUpdates'][0])
    {
        $request = $this->forgeUpdatesRequest($id_slug, $neoforge, $hostIndex, $variables, $contentType);
     ...
     */
    public function forgeUpdatesAsync($id_slug, $neoforge = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['forgeUpdates'][0])
    {
        return $this->forgeUpdatesAsyncWithHttpInfo($id_slug, $neoforge, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function forgeUpdatesAsyncWithHttpInfo($id_slug, $neoforge = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['forgeUpdates'][0])
    {
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     */
    public function forgeUpdatesRequest($id_slug, $neoforge = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['forgeUpdates'][0])
    {
