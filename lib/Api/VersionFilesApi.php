...
class VersionFilesApi
{
     ...
     * @param  string|null $version_id Version ID to delete the version from, if multiple files of the same hash exist (optional)
     ...
     * @param  string $hash The hash of the file, considering its byte content, and encoded in hexadecimal (required)
     * @param  string $algorithm The algorithm of the hash (required)
     * @param  \Aternos\ModrinthApi\Model\GetLatestVersionFromHashBody|null $get_latest_version_from_hash_body Parameters of the updated version requested (optional)
     ...
     *
     * @param  \Aternos\ModrinthApi\Model\GetLatestVersionsFromHashesBody|null $get_latest_versions_from_hashes_body Parameters of the updated version requested (optional)
     ...
     * @param  string $hash The hash of the file, considering its byte content, and encoded in hexadecimal (required)
     * @param  string $algorithm The algorithm of the hash (required)
     * @param  bool|null $multiple Whether to return multiple results when looking for this hash (optional, default to false)
     ...
     *
     * @param  \Aternos\ModrinthApi\Model\HashList|null $hash_list Hashes and algorithm of the versions requested (optional)
