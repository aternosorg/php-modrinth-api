...
class UsersApi
{
     ...
     * @return void
     */
    public function deleteUserIcon($id_username, string $contentType = self::contentTypes['deleteUserIcon'][0])
    {
        $this->deleteUserIconWithHttpInfo($id_username, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteUserIconWithHttpInfo($id_username, string $contentType = self::contentTypes['deleteUserIcon'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteUserIconAsync($id_username, string $contentType = self::contentTypes['deleteUserIcon'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteUserIconAsyncWithHttpInfo($id_username, string $contentType = self::contentTypes['deleteUserIcon'][0])
    {
        $returnType = '';
        $request = $this->deleteUserIconRequest($id_username, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteUserIconRequest($id_username, string $contentType = self::contentTypes['deleteUserIcon'][0])
    {
