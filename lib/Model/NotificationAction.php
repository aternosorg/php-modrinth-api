...
/**
 * NotificationAction Class Doc Comment
 *
 * @category Class
 ...
 */
class NotificationAction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NotificationAction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('action_route', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets title
     *
     * @param string|null $title The friendly name for this action
     *
     * @return self
     */
    ...
    {
        return $this->container['action_route'];
    }

    /**
     * Sets action_route
     *
     * @param string[]|null $action_route The HTTP code and path to request in order to perform this action.
     *
     * @return self
     */
    public function setActionRoute($action_route)
    {
        if (is_null($action_route)) {
            throw new \InvalidArgumentException('non-nullable action_route cannot be null');
        }
        $this->container['action_route'] = $action_route;
