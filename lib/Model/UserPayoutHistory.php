...
/**
 * UserPayoutHistory Class Doc Comment
 *
 * @category Class
 * @package  Aternos\ModrinthApi
 * @author   OpenAPI Generator team
 ...
 */
class UserPayoutHistory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserPayoutHistory';
    ...
    {
        $this->setIfExists('all_time', $data ?? [], null);
    ...
    */
     ...
     * Gets payouts
     *
     * @return \Aternos\ModrinthApi\Model\UserPayoutHistoryEntry[]|null
     */
     ...
     * Sets payouts
     *
     * @param \Aternos\ModrinthApi\Model\UserPayoutHistoryEntry[]|null $payouts A history of all of the user's past transactions
     *
     * @return self
     */
