...
/**
 * LicenseList200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  Aternos\ModrinthApi
 * @author   OpenAPI Generator team
 ...
 */
class LicenseList200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'licenseList_200_response_inner';
    ...
    */
     ...
     * Sets short
     *
     * @param string $short The short identifier of the license
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The full name of the license
     *
     * @return self
     */
