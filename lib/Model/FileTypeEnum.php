...
/**
 * FileTypeEnum Class Doc Comment
 *
 * @category Class
 * @package  Aternos\ModrinthApi
 * @author   OpenAPI Generator team
...
class FileTypeEnum
{
     ...
     */
    public const REQUIRED_RESOURCE_PACK = 'required-resource-pack';

    public const OPTIONAL_RESOURCE_PACK = 'optional-resource-pack';

    public const SOURCES_JAR = 'sources-jar';

    public const DEV_JAR = 'dev-jar';

    public const JAVADOC_JAR = 'javadoc-jar';
    ...
    {
        return [
            self::REQUIRED_RESOURCE_PACK,
            self::OPTIONAL_RESOURCE_PACK,
            self::SOURCES_JAR,
            self::DEV_JAR,
            self::JAVADOC_JAR,
            self::UNKNOWN,
