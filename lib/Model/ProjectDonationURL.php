...
/**
 * ProjectDonationURL Class Doc Comment
 *
 * @category Class
 * @package  Aternos\ModrinthApi
 * @author   OpenAPI Generator team
 ...
 */
class ProjectDonationURL implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectDonationURL';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The ID of the donation platform
     *
     * @return self
     */
     ...
     * Sets platform
     *
     * @param string|null $platform The donation platform this link is to
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url The URL of the donation platform and user
     *
     * @return self
     */
