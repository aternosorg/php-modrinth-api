...
/**
 * ModeratorMessage Class Doc Comment
 *
 * @category Class
 ...
 */
class ModeratorMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModeratorMessage';
    ...
    */
     ...
     * Sets message
     *
     * @param string|null $message The message that a moderator has left for the project
     *
     * @return self
     */
     ...
     * Sets body
     *
     * @param string|null $body The longer body of the message that a moderator has left for the project
     *
     * @return self
     */
