...
/**
 * ModifyReportRequest Class Doc Comment
 *
 * @category Class
 * @package  Aternos\ModrinthApi
 * @author   OpenAPI Generator team
 ...
 */
class ModifyReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'modifyReport_request';
    ...
    */
     ...
     * Sets body
     *
     * @param string|null $body The contents of the report
     *
     * @return self
     */
     ...
     * Sets closed
     *
     * @param bool|null $closed Whether the thread should be closed
     *
     * @return self
     */
