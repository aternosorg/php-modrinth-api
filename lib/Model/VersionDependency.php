...
/**
 * VersionDependency Class Doc Comment
 *
 * @category Class
 * @package  Aternos\ModrinthApi
 * @author   OpenAPI Generator team
 ...
 */
class VersionDependency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VersionDependency';
    ...
    public const DEPENDENCY_TYPE_REQUIRED = 'required';
    public const DEPENDENCY_TYPE_OPTIONAL = 'optional';
    public const DEPENDENCY_TYPE_INCOMPATIBLE = 'incompatible';
    public const DEPENDENCY_TYPE_EMBEDDED = 'embedded';
    ...
    {
        return [
            self::DEPENDENCY_TYPE_REQUIRED,
            self::DEPENDENCY_TYPE_OPTIONAL,
            self::DEPENDENCY_TYPE_INCOMPATIBLE,
            self::DEPENDENCY_TYPE_EMBEDDED,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('dependency_type', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets version_id
     *
     * @param string|null $version_id The ID of the version that this version depends on
     *
     * @return self
     */
     ...
     * Sets project_id
     *
     * @param string|null $project_id The ID of the project that this version depends on
     *
     * @return self
     */
     ...
     * Sets file_name
     *
     * @param string|null $file_name The file name of the dependency, mostly used for showing external dependencies on modpacks
     *
     * @return self
     */
     ...
     *
     * @param string $dependency_type The type of dependency that this version has
     *
     * @return self
     */
