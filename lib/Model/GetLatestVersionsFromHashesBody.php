...
/**
 * GetLatestVersionsFromHashesBody Class Doc Comment
 *
 * @category Class
 * @package  Aternos\ModrinthApi
 * @author   OpenAPI Generator team
 ...
 */
class GetLatestVersionsFromHashesBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetLatestVersionsFromHashesBody';
