...
/**
 * ProjectLicense Class Doc Comment
 *
 * @category Class
 ...
 */
class ProjectLicense implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectLicense';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The SPDX license ID of a project
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The long name of a license
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url The URL to this license
     *
     * @return self
     */
