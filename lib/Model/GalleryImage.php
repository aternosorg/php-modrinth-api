...
/**
 * GalleryImage Class Doc Comment
 *
 * @category Class
 * @package  Aternos\ModrinthApi
 * @author   OpenAPI Generator team
 ...
 */
class GalleryImage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GalleryImage';
    ...
    */
     ...
     * Sets url
     *
     * @param string $url The URL of the gallery image
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param string $created The date and time the gallery image was created
     *
     * @return self
     */
