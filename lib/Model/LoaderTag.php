 ...
 */
class LoaderTag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoaderTag';
    ...
    protected static $setters = [
        'icon' => 'setIcon',
        'name' => 'setName',
        'supported_project_types' => 'setSupportedProjectTypes'
    ];
    ...
    protected static $getters = [
        'icon' => 'getIcon',
        'name' => 'getName',
        'supported_project_types' => 'getSupportedProjectTypes'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('supported_project_types', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['supported_project_types'] === null) {
            $invalidProperties[] = "'supported_project_types' can't be null";
        }
    ...
    {
        return $this->container['supported_project_types'];
    }
