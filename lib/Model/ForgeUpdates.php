...
class ForgeUpdates implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'homepage' => 'string',
        'promos' => '\Aternos\ModrinthApi\Model\ForgeUpdateCheckerPromos'
    ];
    ...
    */
     ...
     * Sets homepage
     *
     * @param string|null $homepage A link to the mod page
     *
     * @return self
     */
     ...
     * Gets promos
     *
     * @return \Aternos\ModrinthApi\Model\ForgeUpdateCheckerPromos|null
     */
     ...
     * Sets promos
     *
     * @param \Aternos\ModrinthApi\Model\ForgeUpdateCheckerPromos|null $promos promos
     *
     * @return self
     */
